    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-info elevation-4">
            ...
            <a href="dashboard.html" class="brand-link">
                <img src="dist/img/AdminLTELogo.png" class="brand-image img-circle elevation-3" style="opacity: 0.8" />
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="category-index" class="nav-link" data-active="index">
                                        <i class="nav-icon fas fa-list-ul"></i>
                                        <p>List</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="category-form" class="nav-link" data-active="form">
                                        <i class="nav-icon fas fa-edit"></i>
                                        <p>Add</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="book-index" class="nav-link" data-active="index">
                                        <i class="nav-icon fas fa-list-ul"></i>
                                        <p>List</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="book-form" class="nav-link" data-active="form">
                                        <i class="nav-icon fas fa-edit"></i>
                                        <p>Add</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="cart-management" class="nav-link" data-active="cart">
                                <i class="nav-icon fas fa-shopping-cart"></i>
                                <p>Cart</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="change-account-password" class="nav-link" data-active="changeAccountPassword">
