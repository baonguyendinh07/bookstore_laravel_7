...
if ($data['sale_off'] > 0) {
    $bookPrice     = '
    <h4>
    <del>' . number_format($data['price']) . 'đ</del><span> -' . $data['sale_off'] . '%</span>
    </h4>
    <h3>' . number_format($data['price'] * (100 - $data['sale_off']) / 100) . 'đ</h3>';
} else {
    $bookPrice    = '<h3>' . number_format($data['price']) . 'đ</h3>';
}
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-xl-4">
                                <div class="product-slick">
                                    <div><img src="{{asset('resources/upload/book/images/'.($data['picture'] ?? 'default.jpg'))}}" alt="" class="img-fluid w-100 blur-up lazyload image_zoom_cls-0"></div>
                                </div>
                            </div>
                ...
                <section class="section-b-space j-box ratio_asos pb-0">
                    <div class="container">
                        ...
                        <div class="row search-product">
                            <!-- san pham lien quan  -->
                            {{showProductBox($theSameBook, asset('resources/upload/book/images'), 50, 'style="height:360px"', '70px', '<div class="col-xl-2 col-md-4 col-sm-6">', '</div>')}}
                        </div>
                    </div>
                </section>
