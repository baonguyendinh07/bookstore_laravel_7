    ...
    <div class="slide-1 home-slider">
        ...
        <div>
            <a href="" class="home text-center">
                <img src="{{asset('resources/upload/slider/images/'.($slider['picture'] ?? 'default.jpg'))}}" alt="" class="bg-img blur-up lazyload">
            </a>
        </div>
        @endforeach
    </div>
        ...
        <div class="row">
            <div class="col">
                <div class="product-4 product-m no-arrow">
                    <!-- content -->
                    {{showProductBox($specialBooks, asset('resources/upload/book/images'), 90, '', '60px')}}
                    <!-- end content -->
                </div>
            </div>
        </div>
